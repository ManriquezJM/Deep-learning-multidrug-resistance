...
ms_files_names = []
ms_files_path = 'DRIAMS_MS/DRIAMS_A_RAW_DATA'# Definir fichero 
...
driams_dataset = pd.read_csv('DRIAMS_csv_sin_espectros/driams_A/e_coli_driams_a.csv')
...
bin_driams_dataset.to_csv('driams_datasets/dataset_elias/e_coli_driams_a_bin1_2000_10000Da_v2.csv', sep=',',index=False)